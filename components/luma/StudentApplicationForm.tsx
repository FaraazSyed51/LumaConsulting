...
function ProjectRanking({
  ...
  return (
    <div className="space-y-2">
      {order.map((id, index) => {
        const project = lumaOpenProjects.find((p) => p.id === id);
...
export default function StudentApplicationForm() {
  ...
  const [rankings, setRankings] = useState<string[]>([...lumaOpenProjectIds]);
  ...
  useEffect(() => {
    ...
    if (highlight && lumaOpenProjectIds.includes(highlight)) {
      ...
      setRankings([highlight, ...lumaOpenProjectIds.filter((id) => id !== highlight)]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setRankings([...lumaOpenProjectIds]);
      clearResume();
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg text-osu-gray-dark-40 max-w-2xl mx-auto">
            One application for all open Fall Luma projects. Read each brief, fill
            out your info, then rank your preferences at the bottom.
          </p>
        </motion.div>
            ...
            <form onSubmit={handleSubmit} className="divide-y divide-osu-gray-light-40">
              ...
              <div className="p-6 md:p-8">
                ...
                <p className="text-sm text-osu-gray-dark-40 mb-5">
                  Review each open project before you apply.
                </p>
