...
export const partnerFaqs: FaqItem[] = [
  ...
  {
    q: "What does it cost?",
    a: "It depends on scope. Some partners pay students, some offer a stipend, and some projects are volunteer. We're upfront about budget and structure the engagement to fit what you can support.",
  },
  {
    q: "How long does a project take?",
    a: "Most run a semester, but smaller deliverables like a landing page or research brief can finish faster. We set the timeline together in the first conversation.",
  },
  {
  ...
  },
  {
    ...
    a: "We'll read your submission and follow up to scope the project, talk timeline, and see if Luma is the right fit. If it is, we match a student team and get things moving.",
  },
];
